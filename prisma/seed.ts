...
async function main() {
  ...
  const allTeamsForMataMata = [...teams, ...mataMataTeams];
...
- 8 times
- 88 jogadores (11 por time)
- 3 campeonatos:
  • Pontos Corridos (com partidas e classificação)
  • Mata-Mata (com fases e chaveamento)
  • Misto (com grupos e partidas)
- Inscrições, partidas, escalações e estatísticas
